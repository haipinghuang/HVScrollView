    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setScrollConfig(new ScrollConfig() {
            ...
            public int[] getShowViewIds() {
                return new int[]{R.id.tvCol1, R.id.tvCol2, R.id.tvCol3, R.id.tvCol4, R.id.tvCol5};
            }
        ...
        listView.setHeaderListData("header", new String[]{"列表1", "列表2", "列表3", "列表4", "列表5"});
